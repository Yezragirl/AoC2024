...
for formula in formulas:
    ...
    calculated = 0
    # number_of_operators_needed = len(vals) - 1
    # number_of_combos = len(maths) ** number_of_operators_needed
